...
import com.orangeschool.common.enums.PayAlarmType;
import com.orangeschool.common.enums.PayCycle;
import com.orangeschool.common.enums.ScheduleType;
import com.orangeschool.common.enums.ScheduleUpdateType;
...
@Data
@Builder
public class UpdateSchedulePaymentDto {
    ...
    @Schema(description = "수정타입", example = "CURRENT_ALL")
    @NotNull
