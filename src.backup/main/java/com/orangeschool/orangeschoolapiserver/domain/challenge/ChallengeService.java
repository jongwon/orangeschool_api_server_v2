...
public class ChallengeService {
    ...
    public void challengeStamp(Long childId, Long challengeId) throws Exception {
        ...
        memberAlarmService.createToSystem("챌린지알림", commonMemberOptional.get().getName() + "이 도장을 달라고 요청했어요!", notification, parent);
    }
    ...
    public void challengeAddStamp(Long challengeId) throws Exception {
        ...
        memberAlarmService.createToSystem("챌린지알림", "요청한 도장을 받았어요!", notification, child);
    }
    ...
    public void challengeRemoveStamp(Long challengeId) throws Exception {
        ...
        memberAlarmService.createToSystem("챌린지알림", "도장이 회수되었어요!", notification, child);
    }
