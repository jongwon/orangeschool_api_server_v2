package com.orangeschool.orangeschoolapiserver.domain.schedule;

import com.google.firebase.messaging.Notification;
import com.orangeschool.orangeschoolapiserver.common.enums.MemberType;
import com.orangeschool.orangeschoolapiserver.common.enums.ScheduleAlarmType;
...
import com.orangeschool.orangeschoolapiserver.domain.calendar.CalendarService;
...
import com.orangeschool.orangeschoolapiserver.domain.schedule.repository.DayMessageRepository;
import com.orangeschool.orangeschoolapiserver.domain.schedule.repository.ScheduleRepository;
import com.orangeschool.orangeschoolapiserver.domain.schedule.repository.SleepInfoRepository;
import com.orangeschool.orangeschoolapiserver.domain.schedule.repository.TodoListRepository;
...
public class ScheduleService {
    ...
    public void createDayMessage(Long commonMemberId, CreateDayMessageDto createDayMessageDto) throws Exception {
        ...
        if (createDayMessageDto.getMemberType() == MemberType.PARENT) {
            ...
            memberAlarmService.createToSystem("메모알림", message, notification, child);
        } else {
            dayMessage.updateChildMessage(createDayMessageDto.getChildMessage());
            memberAlarmService.createToSystem("메모알림", message, notification, parent);
        }
